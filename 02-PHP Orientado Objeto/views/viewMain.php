<?php
    ...
    if (!empty($_POST['form_submit'])) {
        RouteController::rotas($_POST["acao"]);
    }
?>
...
<html lang="pt-br">
    ...
    <nav class="navbar sticky-top navbar-expand-md navbar-dark bg-secondary">
        <div class="container-fluid">
            <a href="viewMain.php" class="navbar-brand ms-sm-3">
                ...
                <span class="ms-3 fs-5">Cadastro PF</span>
            </a>
            ...
            <div class="row">
                <div class="col">
                    <table class="table align-middle caption-top table-striped">
                        <caption>Tabela de <b>PF</b></caption>
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <?php PessoaController::loadPessoas(); ?>
                        </tbody>
                    </table>
                </div>
            </div>
