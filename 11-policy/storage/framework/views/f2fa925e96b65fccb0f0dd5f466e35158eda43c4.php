<div>
    ...
    <table class="table align-middle caption-top table-striped">
        <caption>Tabela de <b>Professor</b></caption>
        <thead>
        <tr>
            <?php $cont=0; ?>
        ...
        <tbody>
            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td class="d-none d-md-table-cell"><?php echo e($item['nome']); ?></td>
                    <td class="d-none d-md-table-cell"><?php echo e($item['email']); ?></td>
                    <td class="d-none d-md-table-cell"><?php echo e($item['siape']); ?></td>
                    ...
                    <td>
                        ...
                        <a href= "<?php echo e(route('professores.edit', $item['id'])); ?>" class="btn btn-success">
                        ...
                        <a nohref style="cursor:pointer" onclick="showInfoModal('Nome: <?php echo e($item['nome']); ?>', 'E-mail: <?php echo e($item['email']); ?>', 'Siape: <?php echo e($item['siape']); ?>')" class="btn btn-primary">
                    ...
                    <form action="<?php echo e(route('professores.destroy', $item['id'])); ?>" method="POST" id="form_<?php echo e($item['id']); ?>">
                        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\ej200\Documents\IFPR ESTUDOS\Desenvolvimento Web II\Atividades-DevWebII\09-10-Autenticacao\resources\views/components/datalistProfessor.blade.php ENDPATH**/ ?>