        ...
        <tbody>
            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td>
                    <a href="<?php echo e(route('alunos.show', $item['id'])); ?>" class="btn btn-warning btn-block align-content-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-grid" viewBox="0 0 16 16">
                        ...
                        <a href= "<?php echo e(route('alunos.edit', $item['id'])); ?>" class="btn btn-success">
                        ...
                        <a nohref style="cursor:pointer" onclick="showInfoModal('<?php echo e($item['nome']); ?>')" class="btn btn-primary">
                    ...
                    <form action="<?php echo e(route('alunos.destroy', $item['id'])); ?>" method="POST" id="form_<?php echo e($item['id']); ?>">
                        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\ej200\Documents\IFPR ESTUDOS\Desenvolvimento Web II\Atividades-DevWebII\09-10-Autenticacao\resources\views/components/datalistAluno.blade.php ENDPATH**/ ?>