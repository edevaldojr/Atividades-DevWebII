            ...
            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href= "<?php echo e(route('eixos.edit', $item['id'])); ?>" class="btn btn-success">
                        ...
                        <a nohref style="cursor:pointer" onclick="showInfoModal('Nome: <?php echo e($item['nome']); ?>')" class="btn btn-primary">
                    ...
                    <form action="<?php echo e(route('eixos.destroy', $item['id'])); ?>" method="POST" id="form_<?php echo e($item['id']); ?>">
                        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\ej200\Documents\IFPR ESTUDOS\Desenvolvimento Web II\Atividades-DevWebII\09-10-Autenticacao\resources\views/components/datalistEixo.blade.php ENDPATH**/ ?>