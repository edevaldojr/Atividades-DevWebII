        ...
        <tbody>
            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td class="d-none d-md-table-cell"><?php echo e($item->curso->nome); ?></td>
                    <td class="d-none d-md-table-cell"><?php echo e($item['carga']); ?></td>
                    <td>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', $item)): ?>
                        <a href= "<?php echo e(route('disciplinas.edit', $item['id'])); ?>" class="btn btn-success">
                        ...
                        <a nohref style="cursor:pointer" onclick="showInfoModal('<?php echo e($item['nome']); ?>', 'Carga: <?php echo e($item['carga']); ?>')" class="btn btn-primary">
                    ...
                    <form action="<?php echo e(route('disciplinas.destroy', $item['id'])); ?>" method="POST" id="form_<?php echo e($item['id']); ?>">
                        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\ej200\Documents\IFPR ESTUDOS\Desenvolvimento Web II\Atividades-DevWebII\09-10-Autenticacao\resources\views/components/datalistDisciplina.blade.php ENDPATH**/ ?>